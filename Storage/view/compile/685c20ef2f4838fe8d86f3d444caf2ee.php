	...
	<div id="rightBoxA">
		...
		<div class="myOrder rightTips">
			<div class="tipsHover">
				...
				<?php }else{?>
					<a href="<?php echo U('Mycenter/index')?>">我的订单</a>
				<?php } ?>
			</div>
		</div>
		<!--我的足迹-->
		<div class="myFootprint rightTips"  style="display: none;">
			<div class="tipsHover">
				<?php if(!isset($_SESSION['info']['cunumber'])) {?>
					<a href="<?php echo U('Member/login')?>">我的足迹</a>
				<?php }else{?>
					<a href="<?php echo U('Mycenter/index')?>">我的足迹</a>
				<?php } ?>
			</div>
		</div>
		...
		<?php if(!isset($_SESSION['info']['cunumber'])) {?>
			<div class="ShoppingCart rightTips">
				...
				<div class="tipsHover">
					<a href="<?php echo U('Member/login')?>">购物车</a>
				</div>
			</div>
		<?php }elseif(empty($_SESSION['cart']['goods'])){?>
			<div class="ShoppingCart rightTips">
				<span id="cartTotal">0</span>
				<div class="tipsHover">
					<a href="<?php echo U('Cart/emptyCart')?>">购物车</a>
				</div>
			</div>
		<?php } else {?>
			<div class="ShoppingCart rightTips">
				<span id="cartTotal"><?php echo $_SESSION['cart']['total_rows']?></span>
				<div class="tipsHover">
